...
class App extends Component {
  initialState = {
    ...
    users: [
      { countryId: '1', name: 'sri Lanka', username: 'Colombo', city: 'Moratuwa' },
      { countryId: '2', name: 'India', username: 'Assam', city: 'Jorhat'},
      { countryId: '3', name: 'China', username: 'guó ', city: 'Beijing' },
    ],
    results: [],
    query: '',
  }
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Input id="inputsearch" icon="search " onChange={this.search} placeholder="Search by Country" />
        <View
          data={data}
